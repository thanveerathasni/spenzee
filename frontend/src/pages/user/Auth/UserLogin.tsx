...
const UserLogin: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="mt-20 max-w-md mx-auto px-6">
        <div className="bg-white dark:bg-black border border-neutral-200 dark:border-neutral-800 rounded-2xl p-8 shadow-xl">
          <h1 className="text-2xl font-black text-center uppercase italic">
            Sign In
          </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 mt-6">
            <input
              ...
              onChange={handleChange}
              placeholder="Email"
              className="w-full px-5 py-4 rounded-xl bg-neutral-50 dark:bg-neutral-900"
            />
            ...
            <button className="w-full py-4 bg-neutral-200 dark:bg-neutral-800 rounded-xl font-black uppercase text-xs">
              Sign In
            </button>

            <GoogleLogin
              onSuccess={(cred) => authApi.googleLogin(cred.credential!)}
              onError={() => toast.error("Google login failed")}
            />
          </form>
        </div>
